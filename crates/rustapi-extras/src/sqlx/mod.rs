    ...
    impl SqlxErrorCategory {
        ...
        fn create_error(&self) -> sqlx::Error {
            match self {
                ...
                SqlxErrorCategory::Protocol => sqlx::Error::Protocol("test protocol error".to_string()),
                SqlxErrorCategory::ColumnNotFound => sqlx::Error::ColumnNotFound("test_column".to_string()),
            }
        }
    }
